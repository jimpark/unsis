...
// We are doing this to store an integer value into a wchar_t string and we
// don't want false end of string values.
#define CODE_SHORT(x) ((WORD)((x) | 0x8000))
// This macro takes a pointer to wchart_t.  Don't worry about sign bit,
// we only store positive integers.
#define DECODE_SHORT(c) ((WORD)(c[0]&0x7FFF))
#define MAX_CODED 0x7FFF
#else
