...
!ifdef MUI_LICENSEPAGE
  ...
  ${LangFileString} MUI_TEXT_LICENSE_SUBTITLE "Lies bitte den Lizenzvertrag durch, bevor du mit der Installation fortfährst."
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM "Falls du alle Bedingungen des Vertrags akzeptierst, klicke auf 'Annehmen'. Du musst die Lizenzvereinbarung anerkennen, um $(^NameDA) installieren zu können."
...
!ifdef MUI_LICENSEPAGE | MUI_UNLICENSEPAGE
  ${LangFileString} MUI_INNERTEXT_LICENSE_TOP "Drücke die Bild-nach-unten-Taste, um den Rest des Lizenzvertrags zu sehen."
!endif
