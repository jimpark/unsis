...
!ifdef MUI_WELCOMEPAGE
  ${LangFileString} MUI_TEXT_WELCOME_INFO_TITLE "Vítejte v průvodci instalací $(^NameDA)"
...
!ifdef MUI_LICENSEPAGE
  ...
  ${LangFileString} MUI_TEXT_LICENSE_SUBTITLE "Před instalací $(^NameDA) si prosím prostudujte licenční podmínky."
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM "Jestliže souhlasíte se všemi podmínkami ujednání, pokračujte kliknutím na tlačítko Souhlasím. Pro instalaci $(^NameDA) je souhlas s licenčním ujednáním nutný."
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM_CHECKBOX "Jestliže souhlasíte se všemi podmínkami ujednání, zaškrtněte níže uvedenou volbu. Pro instalaci $(^NameDA) je nutné souhlasit s licenčním ujednáním. $_CLICK"
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Jestliže souhlasíte se všemi podmínkami ujednání, zvolte první z možností uvedených níže. Pro instalaci $(^NameDA) je nutné souhlasit s licenčním ujednáním. $_CLICK"
!endif

!ifdef MUI_UNLICENSEPAGE
  ${LangFileString} MUI_UNTEXT_LICENSE_TITLE "Licenční ujednání"
  ${LangFileString} MUI_UNTEXT_LICENSE_SUBTITLE "Před odinstalováním $(^NameDA) si prosím prostudujte licenční podmínky."
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM "Jestliže souhlasíte se všemi podmínkami ujednání, zvolte 'Souhlasím' pro pokračování. Pro odinstalování $(^NameDA) je nutné souhlasit s licenčním ujednáním."
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_CHECKBOX "Jestliže souhlasíte se všemi podmínkami ujednání, zaškrtněte níže uvedenou volbu. Pro odinstalování $(^NameDA) je nutné souhlasit s licenčním ujednáním. $_CLICK"
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Jestliže souhlasíte se všemi podmínkami ujednání, zvolte první z níže uvedených možností. Pro odinstalování $(^NameDA) je nutné souhlasit s licenčním ujednáním. $_CLICK"
!endif
...
!ifdef MUI_INSTFILESPAGE
  ...
  ${LangFileString} MUI_TEXT_INSTALLING_SUBTITLE "Vyčkejte prosím na dokončení instalace $(^NameDA)."
...
!ifdef MUI_UNINSTFILESPAGE
  ...
  ${LangFileString} MUI_UNTEXT_UNINSTALLING_SUBTITLE "Vyčkejte prosím na dokončení odinstalace $(^NameDA)."
...
!ifdef MUI_FINISHPAGE
  ${LangFileString} MUI_TEXT_FINISH_INFO_TITLE "Dokončení instalace $(^NameDA)"
  ${LangFileString} MUI_TEXT_FINISH_INFO_TEXT "Program $(^NameDA) byl nainstalován na váš počítač.$\r$\n$\r$\nZavřete prosím toto okno kliknutím na tlačítko Dokončit."
  ${LangFileString} MUI_TEXT_FINISH_INFO_REBOOT "Pro dokončení instalace $(^NameDA) je nutno restartovat počítač. Chcete restatovat nyní?"
!endif

!ifdef MUI_UNFINISHPAGE
  ${LangFileString} MUI_UNTEXT_FINISH_INFO_TITLE "Dokončuji odinstalačního průvodce $(^NameDA)"
  ${LangFileString} MUI_UNTEXT_FINISH_INFO_TEXT "Program $(^NameDA) byl odinstalován z Vašeho počítače.$\r$\n$\r$\nKlikněte na 'Dokončit' pro ukončení tohoto průvodce."
...
!ifdef MUI_FINISHPAGE | MUI_UNFINISHPAGE
  ...
  ${LangFileString} MUI_TEXT_FINISH_RUN "&Spustit $(^NameDA)"
  ${LangFileString} MUI_TEXT_FINISH_SHOWREADME "Zobrazit &Readme"
  ${LangFileString} MUI_BUTTONTEXT_FINISH "&Dokončit"  
!endif

!ifdef MUI_STARTMENUPAGE
  ${LangFileString} MUI_TEXT_STARTMENU_TITLE "Zvolte složku v Nabídce Start"
  ${LangFileString} MUI_TEXT_STARTMENU_SUBTITLE "Zvolte složku v Nabídce Start pro zástupce $(^NameDA)."
...
!ifdef MUI_UNCONFIRMPAGE
  ${LangFileString} MUI_UNTEXT_CONFIRM_TITLE "Odinstalovat $(^NameDA)"
  ${LangFileString} MUI_UNTEXT_CONFIRM_SUBTITLE "Odebrat $(^NameDA) z Vašeho počítače."
!endif

!ifdef MUI_ABORTWARNING
  ${LangFileString} MUI_TEXT_ABORTWARNING "Opravdu chcete ukončit instalaci $(^Name)?"
!endif
