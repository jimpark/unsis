...
;Edited by FDSIMON in December 2009
...
!ifdef MUI_LICENSEPAGE
  ...
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM "Jika Saudara setuju dan menerima semua pernyataan, tekan tombol Saya Setuju untuk melanjutkan. Saudara harus setuju untuk memulai instalasi $(^NameDA)."
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM_CHECKBOX "Jika Saudara setuju dan menerima semua pernyatan, beri tanda centang. Saudara harus setuju untuk memulai instalasi $(^NameDA). $_CLICK"
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Jika Saudara setuju dan menerima semua pernyataan, pilihlah salah satu item dibawah ini. Saudara harus setuju untuk memulai instalasi $(^NameDA). $_CLICK"
!endif
...
!ifdef MUI_UNLICENSEPAGE
  ...
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM "Jika Saudara setuju dan menerima semua pernyataan, tekan tombol Saya Setuju untuk melanjutkan. Saudara harus setuju untuk memulai proses penghapusan $(^NameDA)."
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_CHECKBOX "Jika Saudara setuju dan menerima semua pernyataan, beri tanda centang. Saudara harus setuju untuk memulai proses penghapusan $(^NameDA). $_CLICK"
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Jika Saudara setuju dan menerima semua pernyataan, pilihlah salah satu item dibawah ini. Saudara harus setuju untuk memulai proses penghapusan $(^NameDA). $_CLICK"
!endif
...
!ifdef MUI_FINISHPAGE
  ...
  ${LangFileString} MUI_TEXT_FINISH_INFO_TEXT "$(^NameDA) sudah di instal di komputer Saudara.$\r$\n$\r$\nTekan tombol Selesai untuk menutup program."
  ${LangFileString} MUI_TEXT_FINISH_INFO_REBOOT "Komputer Saudara memerlukan booting ulang untuk menyempurnakan proses instalasi $(^NameDA). Apakah Saudara akan melakukan booting ulang sekarang juga?"
!endif

!ifdef MUI_UNFINISHPAGE
  ${LangFileString} MUI_UNTEXT_FINISH_INFO_TITLE "Menutup program penghapusan $(^NameDA)"
  ${LangFileString} MUI_UNTEXT_FINISH_INFO_TEXT "$(^NameDA) sudah dihapus dari komputer Saudara.$\r$\n$\r$\nTekan tombol Selesai untuk menutup."
  ${LangFileString} MUI_UNTEXT_FINISH_INFO_REBOOT "Komputer Saudara memerlukan booting untuk menyempurnakan proses penghapusan $(^NameDA). Apakah Saudara akan melakukan booting ulang sekarang juga?"
!endif
...
!ifdef MUI_STARTMENUPAGE
  ...
  ${LangFileString} MUI_INNERTEXT_STARTMENU_TOP "Pilih lokasi dari Menu Start untuk meletakkan shortcut program ini. Saudara bisa juga membuat lokasi baru dengan cara menulis nama lokasi yang dikehendaki."
...
!ifdef MUI_UNCONFIRMPAGE
  ...
  ${LangFileString} MUI_UNTEXT_CONFIRM_SUBTITLE "Menghapus $(^NameDA) dari komputer Saudara."
!endif

!ifdef MUI_ABORTWARNING
  ${LangFileString} MUI_TEXT_ABORTWARNING "Apakah Saudara yakin ingin menghentikan proses instalasi $(^Name)?"
!endif

!ifdef MUI_UNABORTWARNING
  ${LangFileString} MUI_UNTEXT_ABORTWARNING "Apakah Saudara yakin ingin menghentikan proses penghapusan $(^Name)?"
!endif
...
!ifdef MULTIUSER_INSTALLMODEPAGE
  ...
  ${LangFileString} MULTIUSER_INNERTEXT_INSTALLMODE_TOP "Apakah Saudara akan melakukan instalasi $(^NameDA) untuk Saudara sendiri atau untuk semua pemakai komputer ini. $(^ClickNext)"
