...
!ifdef MUI_LICENSEPAGE
  ...
  ${LangFileString} MUI_TEXT_LICENSE_SUBTITLE "Lees de licentieovereenkomst voordat je $(^NameDA) installeert."
...
!ifdef MUI_UNLICENSEPAGE
  ...
  ${LangFileString} MUI_UNTEXT_LICENSE_SUBTITLE "Lees de licentieovereenkomst voordat je $(^NameDA) verwijdert."
