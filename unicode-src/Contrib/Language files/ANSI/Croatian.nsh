...
!ifdef MULTIUSER_INSTALLMODEPAGE
  ${LangFileString} MULTIUSER_TEXT_INSTALLMODE_TITLE "Odaberi korisnike"
  ${LangFileString} MULTIUSER_TEXT_INSTALLMODE_SUBTITLE "Odaberite korisnike za koje želite instalirati $(^NameDA)."
  ${LangFileString} MULTIUSER_INNERTEXT_INSTALLMODE_TOP "Odaberite da li želite instalirati $(^NameDA) samo za sebe ili za sve korisnike ovoga kompjuora/raèunala. $(^ClickNext)"
  ${LangFileString} MULTIUSER_INNERTEXT_INSTALLMODE_ALLUSERS "Instaliraj za sve korisnike ovoga kompjuora/raèunala"
  ${LangFileString} MULTIUSER_INNERTEXT_INSTALLMODE_CURRENTUSER "Instaliraj samo za mene"
!endif