...
;Revision by NGUYÊŞN Maònh HuÌng <loveleeyoungae@yahoo.com> 2010-01-25

!insertmacro LANGFILE "Vietnamese" "Tiêìng Viêòt"

!ifdef MUI_WELCOMEPAGE
  ${LangFileString} MUI_TEXT_WELCOME_INFO_TITLE "ChaÌo mıÌng ğêìn võìi Trõò liì CaÌi ğãòt $(^NameDA)"
  ${LangFileString} MUI_TEXT_WELCOME_INFO_TEXT "TriÌnh trõò liì seŞ hıõìng dâŞn baòn viêòc caÌi ğãòt $(^NameDA).$\r$\n$\r$\nBaòn nên ğoìng tâìt caÒ caìc chıõng triÌnh khaìc trıõìc khi bãìt ğâÌu caÌi ğãòt. ĞiêÌu naÌy giuìp viêòc câòp nhâòt caìc tâòp tin hêò thôìng coì thêÒ thıòc hiêòn ğıõòc maÌ không câÌn phaÒi khõÒi ğôòng laòi maìy tiình.$\r$\n$\r$\n$_CLICK"
!endif
...
!ifdef MUI_LICENSEPAGE
  ...
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM "Nêìu baòn châìp nhâòn caìc ğiêÌu khoaÒn cuÒa thoÒa thuâòn, haŞy nhâìn “Tôi ğôÌng yì” ğêÒ tiêìp tuòc. Baòn phaÒi châìp nhâòn thoÒa thuâòn ğêÒ caÌi ğãòt $(^NameDA)."
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM_CHECKBOX "Nêìu baòn châìp nhâòn caìc ğiêÌu khoaÒn cuÒa thoÒa thuâòn, haŞy nhâìn ô bên dıõìi. Baòn phaÒi châìp nhâòn thoÒa thuâòn ğêÒ caÌi ğãòt $(^NameDA). $_CLICK"
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Nêìu baòn châìp nhâòn caìc ğiêÌu khoaÒn cuÒa thoÒa thuâòn, haŞy choòn ô ğâÌu tiên bên dıõìi. Baòn phaÒi châìp nhâòn thoÒa thuâòn ğêÒ caÌi ğãòt $(^NameDA). $_CLICK"
!endif
...
!ifdef MUI_UNLICENSEPAGE
  ...
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM "Nêìu baòn châìp nhâòn caìc ğiêÌu khoaÒn cuÒa thoÒa thuâòn, haŞy nhâìn “Tôi ğôÌng yì” ğêÒ tiêìp tuòc. Baòn phaÒi châìp nhâòn thoÒa thuâòn ğêÒ gõŞ boÒ $(^NameDA)."
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_CHECKBOX "Nêìu baòn châìp nhâòn caìc ğiêÌu khoaÒn cuÒa thoÒa thuâòn, haŞy nhâìn ô bên dıõìi. Baòn phaÒi châìp nhâòn thoÒa thuâòn ğêÒ gõŞ boÒ $(^NameDA). $_CLICK"
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Nêìu baòn châìp nhâòn caìc ğiêÌu khoaÒn cuÒa thoÒa thuâòn, haŞy choòn ô ğâÌu tiên bên dıõìi. Baòn phaÒi châìp nhâòn thoÒa thuâòn ğêÒ gõŞ boÒ $(^NameDA). $_CLICK"
!endif
