...
!ifdef MUI_LICENSEPAGE
  ...
  ${LangFileString} MUI_TEXT_LICENSE_SUBTITLE "Παρακαλούμε ελέγξτε τη συμφωνία άδειας χρήσης πριν εγκαταστήσετε το '$(^NameDA)'."
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM "Εάν αποδέχεστε τους όρους της συμφωνίας, πατήστε το κουμπί Συμφωνώ για να συνεχίσετε. Πρέπει να αποδεχτείτε τη συμφωνία άδειας χρήσης για να εγκαταστήσετε το '$(^NameDA)'."
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM_CHECKBOX "Εάν αποδέχεστε τους όρους της συμφωνίας, κάντε κλικ στην επιλογή παρακάτω. Πρέπει να αποδεχτείτε τη συμφωνία άδειας χρήσης για να εγκαταστήσετε το '$(^NameDA)'. $_CLICK"
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Εάν αποδέχεστε τους όρους της συμφωνίας, κάντε κλικ στην πρώτη επιλογή παρακάτω. Πρέπει να αποδεχτείτε τη συμφωνία άδειας χρήσης για να εγκαταστήσετε το '$(^NameDA)'. $_CLICK"
!endif

!ifdef MUI_UNLICENSEPAGE
  ${LangFileString} MUI_UNTEXT_LICENSE_TITLE "Συμφωνία Άδειας Χρήσης"
  ${LangFileString} MUI_UNTEXT_LICENSE_SUBTITLE "Παρακαλούμε ελέγξτε τη συμφωνία άδειας χρήσης πριν απεγκαταστήσετε το '$(^NameDA)'."
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM "Εάν αποδέχεστε τους όρους της συμφωνίας, πατήστε το κουμπί Συμφωνώ για να συνεχίσετε. Πρέπει να αποδεχτείτε τη συμφωνία άδειας χρήσης για να απεγκαταστήσετε το '$(^NameDA)'."
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_CHECKBOX "Εάν αποδέχεστε τους όρους της συμφωνίας, κάντε κλικ στην επιλογή παρακάτω. Πρέπει να αποδεχτείτε τη συμφωνία άδειας χρήσης για να απεγκαταστήσετε το '$(^NameDA)'. $_CLICK"
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Εάν αποδέχεστε τους όρους της συμφωνίας, κάντε κλικ στην πρώτη επιλογή παρακάτω. Πρέπει να αποδεχτείτε τη συμφωνία άδειας χρήσης για να απεγκαταστήσετε το '$(^NameDA)'. $_CLICK"
!endif

!ifdef MUI_LICENSEPAGE | MUI_UNLICENSEPAGE
  ${LangFileString} MUI_INNERTEXT_LICENSE_TOP "Πατήστε το πλήκτρο Page Down για να δείτε το υπόλοιπο της συμφωνίας άδειας χρήσης."
!endif
...
!ifdef MUI_INSTFILESPAGE
  ...
  ${LangFileString} MUI_TEXT_INSTALLING_SUBTITLE "Παρακαλούμε περιμένετε όσο το '$(^NameDA)' εγκαθίσταται."
...
!ifdef MUI_UNINSTFILESPAGE
  ...
  ${LangFileString} MUI_UNTEXT_UNINSTALLING_SUBTITLE "Παρακαλούμε περιμένετε όσο το '$(^NameDA)' απεγκαθίσταται."
...
!ifdef MUI_STARTMENUPAGE
  ...
  ${LangFileString} MUI_TEXT_STARTMENU_SUBTITLE "Επιλέξτε έναν φάκελο του μενού Έναρξη για τις συντομεύσεις του '$(^NameDA)'."
  ${LangFileString} MUI_INNERTEXT_STARTMENU_TOP "Επιλέξτε έναν φάκελο του μενού Έναρξη για τις συντομεύσεις του προγράμματος. Μπορείτε επίσης να εισαγάγετε ένα όνομα για να δημιουργήσετε έναν νέο φάκελο."
