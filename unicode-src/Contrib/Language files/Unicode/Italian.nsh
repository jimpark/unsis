...
!ifdef MUI_LICENSEPAGE
  ...
  ${LangFileString} MUI_TEXT_LICENSE_SUBTITLE "Leggere le condizioni della licenza d'uso prima di installare $(^NameDA)."
  ...
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Se si accettano i termini della licenza d'uso, selezionare la prima delle opzioni sottoindicate. È necessario accettare i termini della licenza d'uso per installare $(^NameDA). $_CLICK"
!endif

!ifdef MUI_UNLICENSEPAGE
  ${LangFileString} MUI_UNTEXT_LICENSE_TITLE "Licenza d'uso"
  ${LangFileString} MUI_UNTEXT_LICENSE_SUBTITLE "Leggere le condizioni della licenza d'uso prima di disinstallare $(^NameDA)."
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM "Se si accettano pienamente i termini della licenza d'uso scegliere Accetto per continuare. È necessario accettare i termini della licenza d'uso per disinstallare $(^NameDA)."
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_CHECKBOX "Se si accettano pienamente i termini della licenza d'uso, selezionare la casella sottostante. È necessario accettare i termini della licenza d'uso per disinstallare $(^NameDA). $_CLICK"
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Se si accettano pienamente i termini della licenza d'uso, selezionare la prima delle opzioni sottoindicate. È necessario accettare i termini della licenza d'uso per disinstallare $(^NameDA). $_CLICK"
!endif

!ifdef MUI_LICENSEPAGE | MUI_UNLICENSEPAGE
  ${LangFileString} MUI_INNERTEXT_LICENSE_TOP "Premere Pagina GIÙ per vedere il resto della licenza d'uso."
!endif
...
!ifdef MUI_UNCOMPONENTSPAGE
  ${LangFileString} MUI_UNTEXT_COMPONENTS_TITLE "Selezione dei componenti"
  ${LangFileString} MUI_UNTEXT_COMPONENTS_SUBTITLE "Selezionare i componenti di $(^NameDA) che si desidera disinstallare."
!endif
...
!ifdef MUI_DIRECTORYPAGE
  ${LangFileString} MUI_TEXT_DIRECTORY_TITLE "Selezione della cartella di installazione"
  ${LangFileString} MUI_TEXT_DIRECTORY_SUBTITLE "Selezionare la cartella nella quale installare $(^NameDA)."
!endif

!ifdef MUI_UNDIRECTORYPAGE
  ${LangFileString} MUI_UNTEXT_DIRECTORY_TITLE "Selezione della cartella da cui disinstallare"
  ${LangFileString} MUI_UNTEXT_DIRECTORY_SUBTITLE "Selezionare la cartella dalla quale disinstallare $(^NameDA)."
!endif

!ifdef MUI_INSTFILESPAGE
  ${LangFileString} MUI_TEXT_INSTALLING_TITLE "Installazione in corso"
  ${LangFileString} MUI_TEXT_INSTALLING_SUBTITLE "Attendere mentre $(^NameDA) viene installato."
...
!ifdef MUI_UNINSTFILESPAGE
  ...
  ${LangFileString} MUI_UNTEXT_UNINSTALLING_SUBTITLE "Attendere mentre $(^NameDA) viene disinstallato."
...
!ifdef MUI_FINISHPAGE
  ...
  ${LangFileString} MUI_TEXT_FINISH_INFO_TEXT "$(^NameDA) è stato installato sul vostro computer.$\r$\n$\r$\nSelezionare Fine per chiudere il programma di installazione."
  ${LangFileString} MUI_TEXT_FINISH_INFO_REBOOT "Il computer deve essere riavviato per completare l'installazione di $(^NameDA). Riavviarlo ora?"
!endif
...
!ifdef MUI_UNFINISHPAGE
  ...
  ${LangFileString} MUI_UNTEXT_FINISH_INFO_REBOOT "Il computer deve essere riavviato per completare l'installazione di $(^NameDA). Riavviarlo ora?"
!endif
...
!ifdef MUI_FINISHPAGE | MUI_UNFINISHPAGE
  ...
  ${LangFileString} MUI_TEXT_FINISH_SHOWREADME "Mostra il file Leggimi"
  ${LangFileString} MUI_BUTTONTEXT_FINISH "&Fine"  
!endif

!ifdef MUI_STARTMENUPAGE
  ${LangFileString} MUI_TEXT_STARTMENU_TITLE "Selezione della cartella del menu Start"
  ${LangFileString} MUI_TEXT_STARTMENU_SUBTITLE "Selezionare una cartella del menu Start per i collegamenti del programma."
  ${LangFileString} MUI_INNERTEXT_STARTMENU_TOP "Selezionare la cartella del menu Start in cui verranno creati i collegamenti al programma. È possibile inserire un nome per creare una nuova cartella."
  ${LangFileString} MUI_INNERTEXT_STARTMENU_CHECKBOX "Non creare i collegamenti al programma."
!endif

!ifdef MUI_UNCONFIRMPAGE
  ${LangFileString} MUI_UNTEXT_CONFIRM_TITLE "Disinstallazione di $(^NameDA)"
  ${LangFileString} MUI_UNTEXT_CONFIRM_SUBTITLE "$(^NameDA) verrà rimosso dal computer."
!endif

!ifdef MUI_ABORTWARNING
  ${LangFileString} MUI_TEXT_ABORTWARNING "Interrompere l'installazione di $(^Name)?"
!endif

!ifdef MUI_UNABORTWARNING
  ${LangFileString} MUI_UNTEXT_ABORTWARNING "Interrompere la disinstallazione di $(^Name)?"
!endif

!ifdef MULTIUSER_INSTALLMODEPAGE
  ${LangFileString} MULTIUSER_TEXT_INSTALLMODE_TITLE "Scelta degli utenti"
  ${LangFileString} MULTIUSER_TEXT_INSTALLMODE_SUBTITLE "Scegliere per quali utenti si desidera installare $(^NameDA)."
  ${LangFileString} MULTIUSER_INNERTEXT_INSTALLMODE_TOP "Scegliere se installare $(^NameDA) solo per questo utente o so per tutti gli utenti di questo sistema. $(^ClickNext)"
