...
!ifdef MUI_LICENSEPAGE
  ${LangFileString} MUI_TEXT_LICENSE_TITLE "Уговор о лиценци"
  ${LangFileString} MUI_TEXT_LICENSE_SUBTITLE "Пажљиво прочитајте Уговор о лиценци пре инсталације програма $(^NameDA)."
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM "Ако прихватате све услове Уговора, притисните „Прихватам“ за наставак. Морате прихватити Уговор да бисте инсталирали програм $(^NameDA)."
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM_CHECKBOX "Ако прихватате све услове Уговора, обележите квадратић испод. Морате прихватити Уговор да бисте инсталирали програм $(^NameDA). $_CLICK"
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Ако прихватате све услове Уговора, изаберите прву опцију испод. Морате прихватити Уговор да бисте инсталирали програм $(^NameDA). $_CLICK"
!endif

!ifdef MUI_UNLICENSEPAGE
  ${LangFileString} MUI_UNTEXT_LICENSE_TITLE "Уговор о лиценци"
  ${LangFileString} MUI_UNTEXT_LICENSE_SUBTITLE "Пажљиво прочитајте Уговор о праву коришћења пре деинсталације програма $(^NameDA)."
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM "Ако прихватате све услове Уговора, притисните „Прихватам“ за наставак. Морате прихватити Уговор да бисте деинсталирали програм $(^NameDA)."
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_CHECKBOX "Ако прихватате све услове Уговора, обележите квадратић испод. Морате прихватити Уговор да бисте деинсталирали програм $(^NameDA). $_CLICK"
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Ако прихватате све услове Уговора, изаберите прву опцију испод. Морате прихватити Уговор да бисте деинсталирали програм $(^NameDA). $_CLICK"
!endif

!ifdef MUI_LICENSEPAGE | MUI_UNLICENSEPAGE
  ${LangFileString} MUI_INNERTEXT_LICENSE_TOP "Притисните Page Down да бисте видели остатак Уговора."
!endif
...
!ifdef MUI_ABORTWARNING
  ${LangFileString} MUI_TEXT_ABORTWARNING "Да ли сте сигурни да желите да прекинете инсталацију програма $(^Name)?"
!endif

!ifdef MUI_UNABORTWARNING
  ${LangFileString} MUI_UNTEXT_ABORTWARNING "Да ли сте сигурни да желите да прекинете инсталацију програма $(^Name)?"
!endif
