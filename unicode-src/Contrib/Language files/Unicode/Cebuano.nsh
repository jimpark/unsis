...
!ifdef MUI_LICENSEPAGE
  ...
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM "Kon mouyon ka sa kondisyones sa kasabotan, i-click ang Mouyon Ko aron makapadayon ka. Kinahanglang mouyon ka sa kasabotan aron ma-install ang $(^NameDA)."
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM_CHECKBOX "Kon mouyon ka sa kondisyones sa kasabotan, i-click ang check box sa ubos. Kinahanglang mouyon ka sa kasabotan aron ma-install ang $(^NameDA). $_CLICK"
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Kon mouyon ka sa kondisyones sa kasabotan, pilia ang unang opsiyon sa ubos. Kinahanglang mouyon ka sa kasabotan aron ma-install ang $(^NameDA). $_CLICK"
!endif

!ifdef MUI_UNLICENSEPAGE
  ${LangFileString} MUI_UNTEXT_LICENSE_TITLE "Kasabotan sa Lisensiya"
  ...
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM "Kon mouyon ka sa kondisyones sa kasabotan, i-click ang Mouyon Ko aron makapadayon ka. Kinahanglang mouyon ka sa kasabotan aron ma-uninstall ang $(^NameDA)."
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_CHECKBOX "Kon mouyon ka sa kondisyones sa kasabotan, i-click ang check box sa ubos. Kinahanglang mouyon ka sa kasabotan aron ma-uninstall ang $(^NameDA). $_CLICK"
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Kon mouyon ka sa kondisyones sa kasabotan, pilia ang unang opsiyon sa ubos. Kinahanglang mouyon ka sa kasabotan aron ma-uninstall ang $(^NameDA). $_CLICK"
!endif

!ifdef MUI_LICENSEPAGE | MUI_UNLICENSEPAGE
  ${LangFileString} MUI_INNERTEXT_LICENSE_TOP "Tulpoka ang Page Down aron imong mabasa ang ubang detalye sa kasabotan."
!endif
...
!ifdef MUI_INSTFILESPAGE
  ${LangFileString} MUI_TEXT_INSTALLING_TITLE "Nag-install"
...
!ifdef MUI_UNINSTFILESPAGE
  ${LangFileString} MUI_UNTEXT_UNINSTALLING_TITLE "Nag-uninstall"
...
!ifdef MUI_FINISHPAGE
  ...
  ${LangFileString} MUI_TEXT_FINISH_INFO_TEXT "Na-install na ang $(^NameDA) sa imong computer.$\r$\n$\r$\nI-click ang Human Na aron ma-close ang Setup."
...
!ifdef MUI_UNFINISHPAGE
  ...
  ${LangFileString} MUI_UNTEXT_FINISH_INFO_TEXT "Na-uninstall na ang $(^NameDA) sa imong computer.$\r$\n$\r$\nI-click ang Human Na aron ma-close ang Setup."
...
!ifdef MUI_STARTMENUPAGE
  ...
  ${LangFileString} MUI_INNERTEXT_STARTMENU_CHECKBOX "Ayaw paghimog shortcut"
!endif
