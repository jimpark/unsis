...
!ifdef MUI_INSTFILESPAGE
  ...
  ${LangFileString} MUI_TEXT_ABORT_SUBTITLE "Installasjonen ble ikke riktig utført."
!endif
...
!ifdef MUI_UNINSTFILESPAGE
  ...
  ${LangFileString} MUI_UNTEXT_ABORT_SUBTITLE "Avinstallasjonen ble ikke riktig utført."
!endif

!ifdef MUI_FINISHPAGE
  ${LangFileString} MUI_TEXT_FINISH_INFO_TITLE "Avslutter $(^NameDA) installasjonsveiviser"
  ${LangFileString} MUI_TEXT_FINISH_INFO_TEXT "$(^NameDA) er klart til bruk på din datamaskin.$\r$\n$\r$\nTrykk Ferdig for å avslutte installasjonsprogrammet."
...
!ifdef MUI_UNFINISHPAGE
  ...
  ${LangFileString} MUI_UNTEXT_FINISH_INFO_TEXT "$(^NameDA) er blitt avinstallert fra din datamaskin.$\r$\n$\r$\nTrykk på ferdig for å avslutte denne veiviseren."
...
!ifdef MUI_ABORTWARNING
  ${LangFileString} MUI_TEXT_ABORTWARNING "Er du sikker på at du vil avbryte installasjonen av $(^Name)?"
!endif
