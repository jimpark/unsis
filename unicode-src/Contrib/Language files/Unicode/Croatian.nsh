...
!ifdef MULTIUSER_INSTALLMODEPAGE
  ...
  ${LangFileString} MULTIUSER_INNERTEXT_INSTALLMODE_TOP "Odaberite da li želite instalirati $(^NameDA) samo za sebe ili za sve korisnike ovoga kompjuora/računala. $(^ClickNext)"
  ${LangFileString} MULTIUSER_INNERTEXT_INSTALLMODE_ALLUSERS "Instaliraj za sve korisnike ovoga kompjuora/računala"
