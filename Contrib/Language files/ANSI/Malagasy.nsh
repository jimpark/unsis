...
!ifdef MUI_LICENSEPAGE
  ...
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM_CHECKBOX "Raha ekenao izay voalaza ao amin'ny fifanekena, dia mariho ny efajoro kely eto ambany. Tsy maintsy manaiky an'io fifanekena io ianao vao ho afaka hampiditra ny $(^NameDA). $_CLICK"
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Raha ekenao izay voalaza ao amin'ny fifanekena, dia mariho ilay safidy voalohany eto ambany. Tsy maintsy manaiky an'io fifanekena io ianao vao ho afaka hampiditra ny $(^NameDA). $_CLICK"
!endif
...
!ifdef MUI_UNLICENSEPAGE
  ...
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_CHECKBOX "Raha ekenao izay voalaza ao amin'ny fifanekena, dia mariho ny efajoro kely eto ambany. Tsy maintsy manaiky an'io fifanekena io ianao vao ho afaka hanaisotra ny $(^NameDA). $_CLICK"
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Raha ekenao izay voalaza ao amin'ny fifanekena, dia mariho ilay safidy voalohany eto ambany. Tsy maintsy manaiky an'io fifanekena io ianao vao ho afaka hanaisotra ny $(^NameDA). $_CLICK"
!endif
...
!ifdef MUI_COMPONENTSPAGE | MUI_UNCOMPONENTSPAGE
  ...
  !ifndef NSIS_CONFIG_COMPONENTPAGE_ALTERNATIVE
    ${LangFileString} MUI_INNERTEXT_COMPONENTS_DESCRIPTION_INFO "Tondroy amin'ny totozy ilay component mba hahitana ny mombamomba azy."
  !else
    ${LangFileString} MUI_INNERTEXT_COMPONENTS_DESCRIPTION_INFO "Tondroy amin'ny totozy ilay component mba hahitana ny mombamomba azy."
  !endif
!endif
...
!ifdef MUI_STARTMENUPAGE
  ${LangFileString} MUI_TEXT_STARTMENU_TITLE "Hifidy Toerana Fampirimana ao Amin'ny Start Menu/Menu Démarrer"
  ${LangFileString} MUI_TEXT_STARTMENU_SUBTITLE "Mifidiana toerana fampirimana ao amin'ny Start Menu/Menu Démarrer mba hametrahana ny hitsin-dalan'ny $(^NameDA)."
  ${LangFileString} MUI_INNERTEXT_STARTMENU_TOP "Misafidiana na mamoròna toerana tianao hametrahana ny hitsin-dalan'ny $(^NameDA) ao amin'ny Start Menu/Menu Démarrer."
...
!ifdef MULTIUSER_INSTALLMODEPAGE
  ...
  ${LangFileString} MULTIUSER_INNERTEXT_INSTALLMODE_TOP "Lazao raha ianao irery no tianao ho afaka hampiasa ny $(^NameDA), na tianao ho afaka hampiasa azy izay rehetra miray ordinatera aminao. $(^ClickNext)"
